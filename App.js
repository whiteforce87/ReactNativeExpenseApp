...
import RecentExpenenses from './screens/RecentExpences';
...
function ExpensesOverview(){
        return (<BottomTabs.Navigator screenOptions={ ({navigation}) =>  ({
           ...
           <BottomTabs.Screen name="RecentExpenses" component={RecentExpenenses} options={
            {
        ...
        <ExpensesContextProvider>
          <NavigationContainer >
            <Stack.Navigator screenOptions={
              ...
              <Stack.Screen name='ExpensesOverview' component={ExpensesOverview} options={{headerShown: false}}></Stack.Screen>
